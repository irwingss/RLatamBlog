...
Para codificar un mensaje en vectores numéricos en R, puedes hacer la conversión de la cadena de texto usado:
```{r}
# Convertir "Mi mensaje misterioso" a vector numérico
mensaje <- DescTools::CharToAsc("Mi mensaje misterioso")
print(mensaje)
```
